...
<input type="hidden" id="status" value="<%= request.getAttribute("status")%>">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group form-button">
								<input type="submit" name="signup" id="signup"
									...
									<p>Already member ? <a href="login.jsp" >Login</a><p/>
							</div>
						</form>
					</div>
	...
	if(status == "invalidPhoneno"){
		swal("Congrats","Please Enter PhoneNo","error");
	}
	if(status == "Enter valid phno"){
		swal("Congrats","Enter Valid phoneno","error");
	}
	if(status == "confirm"){
		swal("Congrats","Agree terms and condition","error");
	}
	</script>
